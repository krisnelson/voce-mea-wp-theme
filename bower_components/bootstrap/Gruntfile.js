...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      'clean-css-docs': {
        command: 'echo "NO DOCS"' //npm run clean-css'
      },
      postcss: {
        command: 'npm run postcss'
      },
      'postcss-docs': {
        command: 'echo "NO DOCS"' //npm run postcss-docs'
      },
      htmlhint: {
      ...
      'sass-docs': {
        command: 'echo "NO DOCS"' //npm run sass-docs'
      },
      'scss-lint': {
        command: 'echo "NO LINT"' //npm run scss-lint'
      },
      'scss-lint-docs': {
        command: 'echo "NO LINT"' //npm run scss-lint-docs'
      },
      uglify: {
        command: 'npm run uglify'
      },
      'uglify-docs': {
        command: 'echo "NO DOCS" //npm run uglify-docs'
      }
    },
  ...
  if (runSubset('core') &&
    ...
    testSubtasks = testSubtasks.concat(['dist-css', 'dist-js', 'test-scss', 'qunit'])
  }
  ...
  //grunt.registerTask('lint-docs-css', ['exec:clean-css-docs'])
